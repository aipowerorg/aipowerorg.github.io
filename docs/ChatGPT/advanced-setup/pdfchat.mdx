...
Please note that the PDF chat feature only works with embeddings, so make sure you have configured your [Pinecone](/docs/embeddings#pinecone-setup) correctly.
...
<Tabs>
  <TabItem value="shortcode" label="Shortcode" default>
    <ul>
        ...
        <li>Make sure that the <b>Use Embeddings</b> box is checked. This option enables the chatbot to use embeddings for better understanding and response accuracy.</li>
