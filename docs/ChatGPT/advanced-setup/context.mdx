...
The default value is set at 10, but it can be adjusted to any value between 3 and 20 based on your requirements.
...
It's important to note that setting this number too large could exhaust the max token limit, causing users to receive errors such as *"This model's maximum context length.."*, etc.

Therefore, it's recommended not to set this number too high to avoid such issues and ensure a smooth user experience.
    ...
    <ul>
        ...
        <li>Look for the <b>Remember Conversation</b> and <b>Remember Conversation Up To</b> options:</li>
            <ul>
                ...
                <li><b>Remember Conversation Up To</b>: Set the number of messages that the chatbot will remember from the conversation history. The default value is 10, but you can set it to any value between 3 and 20 based on your requirements.</li>
            </ul>
...
Learn more about [Embeddings](/docs/embeddings/embeddings.mdx).
