...
import MemoryShortcodeLimit from '/img/chatgpt/memory-shortcode-limit.png';
...
The default is 10, but it can be adjusted between 3 and 50 based on your needs.
...
<Tabs>
  <TabItem value="shortcode" label="Shortcode" default>
    <ul>
        ...
        <img src={MemoryShortcode} width="600" />
        <li>Look for the <b>Memory</b> and <b>Limit</b> options:</li>
            <ul>
                ...
                <li><b>Limit</b>: Scroll down and click on "Show Additional Options". Set the number of messages that the chatbot will remember from the conversation history. The default value is 10, but you can set it to any value between 3 and 50 based on your requirements.</li>
            </ul>
        <img src={MemoryShortcodeLimit} width="300" />
        <li>After adjusting the settings, click on the <b>Save</b> button to apply the changes.</li>
    </ul>
    </TabItem>
<TabItem value="widget" label="Widget">
    <ul>
        ...
        <li>Look for the <b>Memory</b> and <b>Limit</b> options:</li>
            <ul>
                <li><b>Memory</b>: Toggle this switch to enable the chatbot to remember the conversation history.</li>
                <li><b>Limit</b>: Set the number of messages that the chatbot will remember from the conversation history. The default value is 10, but you can set it to any value between 3 and 50 based on your requirements.</li>
            </ul>
        <img src={MemoryShortcodeLimit} width="300" />
        <li>After adjusting the settings, click on the <b>Save</b> button to apply the changes.</li>
    </ul>
...
You can manage and sync your indices via the **AI Training - Settings** tab.
...
You can choose a threshold between 1 and 100, with the default set at 50. 

If the confidence score of an answer is below 50, it will not be used by the chatbot. 
