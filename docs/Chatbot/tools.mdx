...
import APISearch from '/img/chatbot/tools/internet/apienable.png';
import APIEnable2 from '/img/chatbot/tools/internet/apienable2.png';
import cse1 from '/img/chatbot/tools/internet/cse1.png';
import cse2 from '/img/chatbot/tools/internet/cse2.png';
import cse3 from '/img/chatbot/tools/internet/cse3.png';
import InternetDemo from '/img/chatbot/tools/internet/demo.png';
import InternetSettings from '/img/chatbot/tools/internet/internet-settings.png';
import InternetSettingsWindow from '/img/chatbot/tools/internet/internet-settings-window.png';
import GoogleAPIKey from '/img/chatbot/tools/internet/google-api-key.png';
import GoogleCSE from '/img/chatbot/tools/internet/google-cse.png';
import GoogleCloud from '/img/chatbot/google/console.png';
import GoogleCloudProject1 from '/img/chatbot/google/project1.png';
import GoogleCloudProject2 from '/img/chatbot/google/project2.png';
import Dashboard from '/img/chatbot/google/dashboard.png';
import APIOverview from '/img/chatbot/google/api-overview.png';
import APIEnable from '/img/chatbot/google/api-enable.png';
import Billing from '/img/chatbot/google/billing.png';
import Billing2 from '/img/chatbot/google/billing2.png';
import Credentials from '/img/chatbot/google/credentials.png';
import Credentials2 from '/img/chatbot/google/cloud-api.png';

import EnableStreaming from '/img/chatbot/tools/streaming/enable-streaming.png';

import samplefeedback from '/img/chatbot/tools/feedback/feedback-sample.png';
import fbbuttons from '/img/chatbot/tools/feedback/feedback-buttons.png';
import viewfb from '/img/chatbot/tools/feedback/view-fb.png';
import EnableFeedback from '/img/chatbot/tools/feedback/enable-feedback.png';
import FeedbackSettings from '/img/chatbot/tools/feedback/feedback-settings.png';

import EnableImageUpload from '/img/chatbot/tools/image/enable-image-upload.png';
import ImageUploadSettings from '/img/chatbot/tools/image/image-upload-settings.png';
import demo from '/img/chatbot/tools/image/demo.png';

import EnableS2T from '/img/chatbot/tools/speech/enable-speech-to-text.png';
import S2TSettings from '/img/chatbot/tools/speech/speech-to-text-settings.png';
import EnableT2SOpenAI from '/img/chatbot/tools/speech/enable-t2s-openai.png';
import T2SGoogleAPIKey from '/img/chatbot/tools/speech/t2s-google-api-key.png';
import T2SGoogleSyncVoices from '/img/chatbot/tools/speech/t2s-google-sync-voices.png';
import EnableT2SGoogle from '/img/chatbot/tools/speech/enable-t2s-google.png';
import EnableT2S from '/img/chatbot/tools/speech/enable-text-to-speech.png';

import APIKey1 from '/img/chatbot/elevenlabs/api-key.png';
import APIKey2 from '/img/chatbot/elevenlabs/api-key2.png';
import ElevenLabsAPIKey from '/img/chatbot/tools/speech/elevenlabs-api-key.png';
import T2SElevenLabsSyncVoices from '/img/chatbot/tools/speech/t2s-elevenlabs-sync-voices.png';
import EnableT2SElevenLabs from '/img/chatbot/tools/speech/enable-t2s-elevenlabs.png';

import ElevenLabs from '/img/chatbot/elevenlabs/elevenlabs.png';
import ElevenLabsSample from '/img/chatbot/elevenlabs/sample.png';
import SyncVoices from '/img/chatbot/elevenlabs/sync-voices.png';
import ApiSave from '/img/chatbot/google/api-save.png';
import Sync from '/img/chatbot/google/sync.png';
import Google from '/img/chatbot/google/google.png';

import starters from '/img/chatbot/tools/starters/starters.png';
import EnableStarters from '/img/chatbot/tools/starters/enable-starters.png';
import StartersSetup from '/img/chatbot/tools/starters/starters-setup.png';
import hideconversations from '/img/chatbot/tools/starters/hide-conversations.png';

import EnableLead from '/img/chatbot/tools/lead/enable-lead.png';
import LeadSettings from '/img/chatbot/tools/lead/lead-settings.png';
import LeadDemo from '/img/chatbot/tools/lead/lead-demo.png';
import LeadLogs from '/img/chatbot/tools/lead/lead-logs.png';
