...
import Parameters from '/img/chatgpt/ai-settings/parameters.png';
import SelectingProvider from '/img/chatgpt/ai-settings/selecting-provider.png';
import SelectingModel from '/img/chatgpt/ai-settings/selecting-model.png'
import SyncingModels from '/img/chatgpt/ai-settings/syncing-models.png';
