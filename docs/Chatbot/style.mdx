...
import StyleTab from '/img/chatgpt/style/style-tab.png';
import Interface1 from '/img/chatgpt/style/interface1.png';
import TypeWriter from '/img/chatgpt/style/typewriter.png';
