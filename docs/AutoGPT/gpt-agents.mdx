...
- **Queue Processor**: The central GPT Agent responsible for processing tasks in the Queue tab, submitted by other agents. This agent must be configured for the other GPT Agents to function.
- **Google Sheets**: Responsible for retrieving data from configured Google Sheets at defined intervals and sending it to the Queue Processor agent for processing. Available in Pro plan.
- **RSS**: Responsible for retrieving data from entered RSS feeds at defined intervals and sending it to the Queue Processor for processing. Available in Pro plan.
- **Embeddings**: Responsible for monitoring new posts, pages, and WooCommerce products; once published, it embeds them in a vector database and indexes them to make the content available for the chatbot.
...
By meeting these requirements, you can ensure optimal performance and compatibility for AutoGPT and its GPT Agents within your WordPress environment.
...
**queue_trigger_for_multi_site.php**
```jsx
<?php
$_SERVER['HTTP_HOST'] = 'CHANGE_WITH_YOUR_DOMAIN';
...
**embeddings_trigger_for_single_site.php**
```jsx
<?php
require __DIR__.'/wp-load.php';
...
**embeddings_trigger_for_multi_site.php**
```jsx
<?php
$_SERVER['HTTP_HOST'] = 'CHANGE_WITH_YOUR_DOMAIN';
$_SERVER['REMOTE_ADDR'] = '127.0.0.1';
...
**rss_trigger_for_single_site.php**
```jsx
<?php
require __DIR__.'/wp-load.php';
...
**rss_trigger_for_multi_site.php**
```jsx
<?php
$_SERVER['HTTP_HOST'] = 'CHANGE_WITH_YOUR_DOMAIN';
$_SERVER['REMOTE_ADDR'] = '127.0.0.1';
...
**sheets_trigger_for_single_site.php**
```jsx
<?php
require __DIR__.'/wp-load.php';
...
**sheets_trigger_for_multi_site.php**
```jsx
<?php
$_SERVER['HTTP_HOST'] = 'CHANGE_WITH_YOUR_DOMAIN';
$_SERVER['REMOTE_ADDR'] = '127.0.0.1';
