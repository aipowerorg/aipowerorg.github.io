...
import NameApp from '/img/autogpt/twitter/name-app.png';
...
- On the left menu, find and click on **Overview** under the **Projects & Apps** section.
- Next, click on **Create App**. 

<img src={CreateApp} width="700" />

- On the page that opens up, enter a suitable name (for example: my awesome gpt bot) for your bot and hit **Create**.
