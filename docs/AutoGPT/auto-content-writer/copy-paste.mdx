...
import CopyPasteImport from '/img/autogpt/copy-paste/copy-paste.png';
import CopyPasteImport2 from '/img/autogpt/copy-paste/copy-paste2.png';
...
- Navigate to the **AutoGPT - Copy-Paste** tab, and ensure that you have completed the [Cron Job setup](/docs/AutoGPT/gpt-agents#cron-job-setup), which is essential for the Copy-Paste module to operate efficiently.

<img src={CopyPasteImport} />

- Paste the desired titles into the text box, with one title per line, and choose whether to save the content as a draft or publish it immediately, select the post category, author and click the **Generate** button. Learn more about content settings [here](/docs/category/express-mode).

<img src={CopyPasteImport2} width="500" />
