...
When our plugin is installed for the first time, it comes with **1500** as the default Maximum Length value.

However you can change it from the **Maximum Length** field in the **AI Engine** tab.
