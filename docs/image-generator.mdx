...
The Image Generator feature of our plugin allows you to generate images using advanced AI models such as **DALL-E** and various models available on Replicate, including  Flux, Stable Diffusion, SDXL, Kandinsky, and more.
...
<iframe width="100%" height="450" src="https://www.youtube.com/embed/KYArfalJBbE" title="WordPress Image Generator with DALL-E and Replicate" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
...
Now, everything is set up, and you can start generating images.

- Navigate to the **Image Generator** and switch to **Replicate** tab.
...
- Simply click on an image to check its details. While our plugin automatically assigns the prompt as **alternative text**, **caption**, **description**, and **title**, you have the freedom to modify them as per your preference.
...
Replicate supports sizes from **128x128** to **1024x1024** and can generate **up to 2 images** per request.

### Settings

In addition to the general settings, **Replicate** offers some unique features:
...
Integrating AI-driven image generators into your website can improve user experience by providing interactive features.

This guide will explain how you can embed the DALL-E and Replicate image generators into your website using shortcodes.
...
In this case, the shortcodes will display the DALL-E and Replicate image generators.
...
#### Displaying Both DALL-E and Replicate

To allow users to generate images using both the DALL-E and Replicate models, use the following shortcode:
...
#### Displaying Only Replicate

To display only the Replicate model, use the following shortcode:
...
- Please note that our plugin is not capable of tracking usage for the 'Replicate' feature due to constraints in the provided API. This feature does not supply the necessary information for our plugin to track its usage effectively. Therefore, if you plan to implement a usage-based charge system for your users, we advise against enabling the 'Replicate' feature.
